...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    if (widget.echoAR == null)
      widget.echoAR = EchoAR(apiKey: "round-leaf-0925");
    String imageLink= await widget.echoAR
        .getModelLinkFromEntryId("fd073e43-ebb6-4b9f-bbf9-b8d2731d5b24");
    String gifLink= await widget.echoAR
        .getModelLinkFromEntryId("fd073e43-ebb6-4b9f-bbf9-b8d2731d5b24");
    String path = await widget.echoAR.getModelFromEntryId("fd073e43-ebb6-4b9f-bbf9-b8d2731d5b24");
